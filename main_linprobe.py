...
def get_args_parser():
    parser = argparse.ArgumentParser('STW-MAE linear probing for image classification', add_help=False)
...
def main(args):
    ...
    if args.finetune:
        ...
        # 手动初始化全连接层：遵循MoCo v3的做法
        trunc_normal_(model.head.weight, std=0.01)

    # 仅用于线性概率问题。
    # 技巧：用批量归一化（Batch Normalization, BN）修改模型的头部
