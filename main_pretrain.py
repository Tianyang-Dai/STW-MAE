...
import timm
# assert timm.__version__ == "0.3.2"  # 版本检查
...
def get_args_parser():
    parser = argparse.ArgumentParser('STW-MAE pre-training', add_help=False)
    ...
    parser.add_argument('--Map_name1', type=str, default='STMap_RGB_Align_CSI_CHROM.png')
    parser.add_argument('--Map_name2', type=str, default='WaveletMap_RGB_Align_CSI.png')
...
def main(args):
    if args.dataname=='VIPL': 
        ...
        saveRoot = r'/scratch/project_2006419/data/VIPL_Index/VIPL_Map_test' + str(args.fold_num) + str(args.fold_index)
    ...
    if args.dataname=='UBFC':
        ...
        saveRoot = r'/scratch/project_2006419/data/UBFC_Index/UBFC_Map50'
    ...
    if args.reData == 1:
        ...
        Train_Indexa = MyDataset.getIndex(fileRoot, train_index, saveRoot + '_Train', args.Map_name1, 5, frames_num, is_STMap_WaveletMap='STMap')
        Train_Indexa = MyDataset.getIndex(fileRoot, train_index, saveRoot + '_Train', args.Map_name2, 5, frames_num, is_STMap_WaveletMap='WaveletMap')
        Test_Indexa = MyDataset.getIndex(fileRoot, test_index, saveRoot + '_Test', args.Map_name1, 5, frames_num, is_STMap_WaveletMap='STMap')
        Test_Indexa = MyDataset.getIndex(fileRoot, test_index, saveRoot + '_Test', args.Map_name2, 5, frames_num, is_STMap_WaveletMap='WaveletMap')
